...
export const metadata: Metadata = {
  title: "Empresas con Descuentos | SNTE Delegacion D-V-16",
  description:
    "Catalogo de empresas con convenios y descuentos exclusivos para agremiados de la Delegacion D-V-16.",
}
